    ...
    <div class="role-table-content">
      ...
      >
        ...
        <template slot="operate" slot-scope="key, scope">
          <a
            class="iconfont icon-icon-test7 operat-icon"
            title="编辑"
            @click="showModal('modalVisible', scope)"
          ></a>
          <a
            class="iconfont icon-icon-test28 operat-icon"
            title="关联模块"
            @click="showModal('relateVisible', scope)"
          ></a>
          <a
            class="iconfont icon-icon-test18 operat-icon"
            title="添加数据权限管理"
            @click="showModal('authVisible', scope)"
          ></a>
          <a
            class="iconfont icon-icon-test32 operat-icon operat-del"
            title="删除"
          ></a>
        </template>
      </a-table>
